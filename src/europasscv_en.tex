...
\begin{europasscv}
  ...
  \ecvblueitem[1pt]{Course}{Identification and Control of Uncertain System}
  \ecvitem{}{
    ...
    simulation was done using Simulink.
  }
  ...
  \ecvitem{}{
    ...
    with a LQG control system. The trajectory of each vehicle is random or can
    be specified by the user.
    \par
    The software was written in C using the Pthreads library.
    The GUI was done with the game programming library Allegro 4.
  }
  ...
  \ecvitem{}{
    ...
    wheeled robots which move a box to a given position cooperatively in a
