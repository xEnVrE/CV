...
I am a \emph{PhD candidate} in \emph{humanoid robotics} with a background in \emph{automation} and \emph{robotics engineering}.
\par
...
\vspace{2mm}
\begin{itemize}
\item {\normalsize Main interests: Bayesian filtering, 6D object pose tracking, Machine learning-aided object tracking, Tactile sensing.}
\end{itemize}}

\section{\textbf{Current Position}}
-\cventryAlt{November, 2021 - current}{PhD candidate @ Humanoid Sensing and Perception (Istituto Italiano di Tecnologia)}{Istituto Italiano di Tecnologia}{Genova}{Italy.}{}

\section{\textbf{Publications}}
\cventryAlt{2021}{ROFT: Real-Time Optical Flow-Aided 6D Object Pose and Velocity Tracking
...
\cventryAlt{November, 2018 - November, 2021}{PhD student @ Humanoid Sensing and
  Perception (Istituto Italiano di Tecnologia)}{Istituto Italiano di
  Tecnologia}{Genova}{Italy.}{}{}
\vspace{-10mm}
\cventryAlt{}{}{}{}{}{I carried out my PhD in Advanced and
  Humanoid Robotics at the Humanoid Sensing and Perception research line at
  Istituto Italiano di Tecnologia in Genova. During the PhD project, I developed
  ...
  using vision and tactile sensors.}
