...
\par
Although the object-tracking problem has been extensively addressed in the Computer Vision and Filtering literature, I strongly fell that there are still many open problems dealing with the application of such algorithms to humanoid robots having impaired proprioception and perception capabilities.
\par
I really look forward to being active part of the Robotic Perception research community with my contribution to the solution of these fascinating and stimulating challenges.
...
\cventryAlt{2019}{In-hand object tracking using 3D visual and tactile measurements}{N. Piga, G. Vezzani, C. Fantacci, U Pattacini, L. Natale}{}{Submitted to IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS), 2019.}{}
